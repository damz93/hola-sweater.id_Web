<?php
   ...
   //include 'csrf.php';
	...
	if (mysqli_num_rows($prosescek)>0) {    
		...
		if (strlen($warna)!=0){	
		$query = "INSERT into t_stok_keluar_temp(PELANGGAN,KODE_TRANSAKSI,KODE_BARANG,JENIS_BARANG,QTY,SIZE_,WARNA,KETERANGAN,WAKTU,TGL,OLEH) VALUES('$tjuan','$kode_transaksi','$kode_barang','$jenis_barang','$qtynya','$size','$warna','$keterangan','$waktu_skg2','$tgl','$oleh')";
