...
<html>
   <head>
      ...
      <title>Tambah Stok - S W E A T E R I N . M E</title>
      ...
      <div class='container'>
		 ...
		 <div class="table-responsive">
            <table class="table" border="0" cellpadding="2" cellspacing="2" align=center>
               ...
               <tr>
                  <th>Jenis Barang</th>
                  <th><input class="form-control form-control-sm" placeholder="JENIS BARANG" maxlength="30" type="text" name="JENIS_BARANG"></th>
               </tr>
               <tr>
                  <th>Size</th>
                  <th><input class="form-control form-control-sm" placeholder="S, M, L, XL, XXL" maxlength="20" type="text" name="SIZE"></th>
               </tr>
               <tr>
                  <th>Warna</th>
                  <th><input class="form-control form-control-sm" placeholder="WARNA" maxlength="30" type="text" name="WARNA"></th>
               </tr>
               <tr>
                  <th>Harga Satuan</th>
                  <td>Rp<input class="form-control form-control-sm mata-uang" placeholder="0" type="text" id="harga" onkeydown="myFunction();" onkeyup="inputTerbilang();" name="HARGA"></td>
               </tr>
               <tr>
                  <th>Qty</th>
