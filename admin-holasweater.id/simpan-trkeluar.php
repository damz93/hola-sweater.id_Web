<?php
	...
	while ($data = mysqli_fetch_array($sql)) {
			...
			$query = "INSERT INTO t_stok_keluar(PELANGGAN,KODE_TRANSAKSI_AUTO,KODE_TRANSAKSI,KODE_BARANG,JENIS_BARANG,SIZE_,WARNA,QTY,TGL,WAKTU,OLEH,KETERANGAN)VALUES('$costumerx','$kode_penjualan2','$noreff','$kode_barang','$jenis_barang','$sizee','$warna','$kuantitas','$tgl','$waktu','$oleh','$keterangan')";
