...
<html>
   <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	   <?php
         ...
         ?>
	  <title>Data Detail Retur Stok Keluar - HOLASWEATER.ID</title>      
   ...
   <div class="bg">
      ...
      ?>
      <h1 align='center' style="background-color:#73607c;color:#d5d5d5">DATA DETAIL RETUR STOK KELUAR </h1>
      ...
      <table id="tabel1" class="table table-hover" border="1" cellpadding="0" cellspacing="1">
         ...
         $juml_keseluruhan = 0;
         $kuantitas = 0;
         $order = mysqli_query($koneksi, "select * from t_stok_keluar_retur where KODE_TRANSAKSI_AUTO='$kode_transaksi' ORDER BY JENIS_BARANG,WARNA ASC");
