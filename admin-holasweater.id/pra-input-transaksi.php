      ...
      <script type="text/javascript">
         function cek_resi(){			   
			...
			/*else if (n != 12){
				...
				return confirm('Lanjut ke input transaksi?');         	 
         	}			
         }
      </script>
   </head>
   <body>
   <a style="background-color:#71b8e4;color:#FFFFFe" href="form-transaksi"> Kembali ke Data Transaksi </a><br>
      <div class="bg">
	   <form method="post" onsubmit="return cek_resi()" id="form_tampil" name="myff2" action="input-transaksi.php">
