...
<html>
   <head>
      ...
      <script type="text/javascript">
         ...
         $('#kuantitasxx').val(obj.qty);
         $('#qty').val("1");			
         var qtynya = $('#kuantitasxx').val(); 
         var qqq = parseInt(qtynya);
         if (qqq <= 0){
         	//alert('aaaa');
         }
         else if(qtynya.length==0){
         }
         else{		
                     ...
                     <div class="exxxxx3">	  
						   <table border="0" class="table" cellpadding="2" cellspacing="2" align="center">
                              ...
                              <tr>
								 ...
								 <h4 class="btn btn-info btn-lg btn-block">Pilih Barang</h4><br>
                                    <input autofocus onkeyup="isi_otomatis()" placeholder="Scan/ Masukkan Kode Barang"  type="text" id="kode_barang" class="form-control form-control-lg">
                                 </td>
                              </tr>
                              <tr>
                                 <th>Jenis Barang</th>
                              ...
                              <tr align='center'>
                                 <th align='right' colspan="2">
                                    <button onclick="autofocuss()" value="simpan" name="input" id="input" class="btn btn-info btn-lg btn-block">Add to List</button>		
                                    <button hidden onclick="autofocuss()" type="reset" class="btn btn-danger btn-lg btn-block">Batal</button>					   
                                 </th>
                              </tr>
                           </table>
                        </div>
