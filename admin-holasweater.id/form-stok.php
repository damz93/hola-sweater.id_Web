...
<html>
   <head>
      ...
      <title>Data Stok - S W E A T E R I N . M E</title>
   ...
   <div class="bg">
      ...
      <a style="background-color:#71b8e4;color:#FFFFFe" href="input-stok"> INPUT DATA STOK </a><br>
      <br>		
      <table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
         ...
         <?php 
            include 'koneksi.php';
            $no=1;
            $data = mysqli_query($koneksi,"select * from t_stok order by ID ASC");
         ...
         <tr align="center">
            <td><?php echo $no++; ?></td>
            <td align="center" hidden><?php echo $tgl; ?></td>
            ...
            <td align="center"><?php echo $notzz; ?></td>
            ...
            <td>			
               ...
               <a hidden href='hapus-stok?kode_barang=<?php echo $d['KODE_BARANG']; ?>' title="Delete Stok" onclick="return confirm('Are you sure you want to delete?')"><img src="img/delete.png" height="100%" ></a>
            </td>
         </tr>
         <?php 
            }
