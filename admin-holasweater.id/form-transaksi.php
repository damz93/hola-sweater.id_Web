...
<html>
    <head>
        ...
        <title>Data Transaksi - S W E A T E R I N . M E</title>
    ...
    <body>
      ...
      <?php 
		...
		?>
            ...
            <a style="background-color:#71b8e4;color:#FFFFFe" href="input-transaksi"> INPUT DATA TRANSAKSI </a><br>
            <br>		
            <table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
                ...
                <?php 
                    ...
                    $data = mysqli_query($koneksi, "select COUNT('QTY') AS JUMLAHH,KODE_TRANSAKSI,TGL,WAKTU,OLEH from t_transaksi GROUP BY KODE_TRANSAKSI ORDER BY KODE_TRANSAKSI DESC");
                ...
                <tr align="center">
                    ...
                    <td><a target="_BLANK" href='form-transaksi-detail?kode_transaksi=<?php
					   ...
					   <a target="_BLANK" href='cetak-transaksi2?kode_transaksi=<?php
						  echo $koder;
						  ?>' title="Cetak Nota Transaksi" onclick="return confirm('Are you sure you want to reprint?')"><img src="img/print.png" height="100%" ></a>|<a href='hapus-transaksi?kode_transaksi=<?php
						  echo $koder;
