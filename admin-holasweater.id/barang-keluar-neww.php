...
<html>
	...
	<body style="background-color:#d5d5d5">
		...
		<div id="online" class="tabcontent">
			<h4 style="color:#73607c">Pilih Barang</h3>			
			<br>
			<br>		
				<div id="kiri">
							...
							<div class="form-group">
								<div class="exxxxx3">
									<table border="0" style="width:100%" class="table table-borderless" cellpadding="2" cellspacing="2" align="center">
										<tr>
											<td colspan="2">
												<input style="font-weight:bold;text-align:center" autofocus onkeyup="isi_otomatis_onl(this.value);" placeholder="Scan Barang" maxlength="20" type="text" id="kode_barang_onl" class="form-control form-control-lg">
											</td>
										</tr>
										<tr hidden>
											<td>
										...
										<tr>
											<td colspan="2"><textarea style="font-weight:bold;color:#fa8d70;font-size:14pt" readonly="readonly" rows="3" cols="4" class="form-control form-control-sm" id="keterangan_onl" placeholder="Detail Barang" maxlength="100" type="text" name="DETAIL"></textarea></td>
										</tr>
										<tr>
										...
										<tr align='center'>
											<th align='right' colspan="2">
												...
												<button onclick="simpan_temp_onl()" value="simpan" name="input_stok_keluar" id="input_stok_keluar_onl" class="btn btn-secondary btn-lg btn-block">Tambahkan</button>		
											</th>
										</tr>
									</table>
								</div>
									...
									<div class="container">
										<table border="0" class="table table-borderless" style="background-color:#eaeaea" cellpadding="2" cellspacing="2" align=center>
											...
											<tr>
												<td></td>
												<td colspan="2">
													<button width="100%" type="reset" value="reset" class="btn btn-secondary btn-lg btn-block">Cancel</button>
												</td>
												<td colspan="1">
		...
		<div id="offline" class="tabcontent">			
			<h4 style="color:#73607c">Pengambilan Barang Harian</h3>			
			<br>
			<br>		
				<div id="kiri">
							...
							<div class="form-group">
								<div class="exxxxx3">
									<table border="0" style="width:100%" class="table table-borderless" cellpadding="2" cellspacing="2" align="center">
										<tr>
											<td colspan="2">
												<input style="font-weight:bold;text-align:center" autofocus onkeyup="isi_otomatis_ofl(this.value);" placeholder="Scan Barang" maxlength="20" type="text" id="kode_barang_ofl" class="form-control form-control-lg">
											</td>
										</tr>
										<tr hidden>
											<td>
										...
										<tr>
											<td colspan="2"><textarea style="font-weight:bold;color:#fa8d70;font-size:14pt" readonly="readonly" rows="3" cols="4" class="form-control form-control-sm" id="keterangan_ofl" placeholder="Detail Barang" maxlength="100" type="text" name="DETAIL"></textarea></td>
										</tr>
										<tr>
											<th><label>Qty</label></th>
										...
										<tr align='center'>
											<th align='right' colspan="2">
												<!--<button onclick="autofocuss()" value="simpan" name="input_stok_keluar" id="input_stok_keluar" class="btn btn-secondary btn-lg btn-block">Tambahkan</button>		-->
												<button onclick="simpan_temp_ofl()" value="simpan" name="input_stok_keluar" id="input_stok_keluar_ofl" class="btn btn-secondary btn-lg btn-block">Tambahkan</button>		
											</th>
										</tr>
									</table>
								</div>
		...
		<div id="history" class="tabcontent">
			<h4 style="color:#73607c">History Barang Keluar</h3>
			<br>
			<br>
		...
		<div id="lainnya" class="tabcontent">
			...
			<div class="content">
				<h4 style="color:#73607c">Barang Keluar Lainnya</h3>				
				<div id="kiri">
							...
							<div class="form-group">
								<div class="exxxxx3">
									<table border="0" style="width:100%" class="table table-borderless" cellpadding="2" cellspacing="2" align="center">
										<tr>
											<td colspan="2">
												<input style="font-weight:bold;text-align:center" autofocus onkeyup="isi_otomatis_lain(this.value);" placeholder="Scan Barang" maxlength="20" type="text" id="kode_barang_lain" class="form-control form-control-lg">
											</td>
										</tr>
										<tr hidden>								
											<td>
										...
										<tr>
											<td colspan="2"><textarea style="font-weight:bold;color:#fa8d70;font-size:14pt" readonly="readonly" rows="3" cols="4" class="form-control form-control-sm" id="keterangan_lain" placeholder="Detail Barang" maxlength="100" type="text" name="DETAIL"></textarea></td>
										</tr>
										<tr>
											<th><label>Qty</label></th>
										...
										<tr align='center'>
											<th align='right' colspan="2">
												<!--<button onclick="autofocuss()" value="simpan" name="input_stok_keluar" id="input_stok_keluar" class="btn btn-secondary btn-lg btn-block">Tambahkan</button>		-->
												<button onclick="simpan_temp_lain()" value="simpan" name="input_stok_keluar" id="input_stok_keluar_lain" class="btn btn-secondary btn-lg btn-block">Tambahkan</button>		
