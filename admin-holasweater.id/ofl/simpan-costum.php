<?php
	...
	$query="INSERT INTO t_costum(KODE_COSTUM,KET_COSTUM,HARGA,STATUS,WAKTU,OLEH,TGL,KETERANGAN)VALUES('$kode_costum','$notes','$harga','$status','$waktu_skg2','$oleh','$tgl','$notes')";
