	...
	<body style="background-color:#d5d5d5">
			...
			<div id="kirkan">
				<table style="width:100%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td>
							<br>
							<h6 align='left' style="background-color:#73607c;color:#ffffff">&nbsp Hasil Import Terakhir...</h6>
							<table style="width:100%" border="0" align="center" class="table table-hover" cellpadding="0" cellspacing="0">								
			...
			<div class="kirkan">
				<form autocomplete="off" action="#" method="get" autocomplete="off">
					<table style="width:100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr align="center">
							<td align="left">
								<h3 style="color:#242424">History Input Barang Masuk</h3>
							</td>
							<td style="width:25%">
		...
		<div id="manual" class="tabcontent">		
			...
			<br>
					...
					<table style="width:97%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
				...
				<div id="kiri">
							...
							<div class="form-group">
								<div class="exxxxx3">
									...
									<table border="0" style="width:100%" class="table table-borderless" cellpadding="2" cellspacing="2" align="center">
										<tr>
											<td colspan="3">
												<input style="font-weight:bold;text-align:center" autofocus onkeyup="isi_otomatis_manual(this.value);" placeholder="Scan Kode Barang" maxlength="20" type="text" id="kode_barang_manual" class="form-control form-control-lg">
											</td>
										</tr>
										<tr hidden>
											<td>
										...
										<tr>
											<td colspan="3"><textarea style="font-weight:bold;color:#fa8d70;font-size:14pt" readonly="readonly" rows="3" cols="4" class="form-control form-control-sm" id="keterangan_manual" placeholder="Detail Barang" maxlength="100" type="text" name="DETAIL"></textarea></td>
										</tr>
										<tr>
											<td align="right"><h6>Masukkan Jumlah</h6></td>
											<td width="25%"><input value="1" maxlength="5" type="text" id="qty_manual" class="form-control form-control-sm mata-uang" onkeyup="inputTerbilang();"></td>
											<td><button onclick="simpan_temp_manual()" value="simpan" name="input_stok_masuk" id="input_stok_masuk_manual" class="btn btn-secondary btn-sm btn-block">Tambahkan</button></td>
										</tr>
					...
					<br>
					<table style="width:50%" border="0" align="left" cellpadding="0" cellspacing="0">
						<tr>
							<td align="left">
								<h5>&nbsp &nbsp Pilih Barang Manual</h5>
							</td>
						</tr>
					</table>
						...
						<div class="table-responsive">
							<div class="form-group">
								<div class="exxxxx3">
									...
									<table border="0" style="width:90%" class="table table-borderless" cellpadding="2" cellspacing="2" align="center">
										...
										<tr>
											<td align="left" colspan="2">
												<h6>Jumlah</h6></td>
											<td align="right">
												<input style="width:50%" value="1" maxlength="5" type="text" id="qty_manual2" class="form-control form-control-sm mata-uang" onkeyup="inputTerbilang();"></td>
											
										</tr>
										<tr align="right">											
											<td></td>
											<td colspan="2"><button onclick="simpan_temp_manual2()" value="simpan" name="input_stok_masuk_manual2" id="input_stok_masuk_manual2" class="btn btn-secondary btn-sm btn-block">Tambahkan</button></td>
										</tr>
									...
									<div class="container">
										<table border="0" class="table table-borderless" style="background-color:#eaeaea" cellpadding="2" cellspacing="2" align=center>
											...
											<tr>
												<td></td>
												<td colspan="2">
													<a class="btn btn-dark btn-lg btn-block" onclick="delete_data2('<?php 
													session_start();
													echo $_SESSION['username'];
													?>');" title="Delete Item">Clear</a>
												</td>
												<td colspan="1">
													<button width="100%" type="submit" value="simpan" class="btn btn-primary btn-lg btn-block">Proses</button>  
												</td>
											</tr>
										</table>
									</div>
			...
			<div class="kirkan">
				<form autocomplete="off" action="#" method="get" autocomplete="off">
					<table style="width:100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr align="center">
							<td align="left">
								<h5 style="color:#242424">Cari Barang</h5>
							</td>
							<td style="width:23%" align="center">
								<select name="jenis_barang_manual93" id="jenis_barang_manual93" class="form-control form-control-lg">
											 <option value="0">Pilih Jenis</option>
                                             <?php
                                                include "koneksi.php";
							...
							<td style="width:23%" align="center">
								<select name="warna_barang_manual93" id="warna_barang_manual93" class="form-control form-control-lg">
											 <option value="0">Pilih Warna</option>
                                             <?php
                                                include "koneksi.php";
							...
							<td style="width:30%" align="center">
								<button onclick="cari_barang1__()" value="simpan1" name="btn_cari_barang1" id="btn_cari_barang1" class="btn btn-primary btn-lg btn-block">Tampilkan STOK</button> 
							</td>							
						</tr>
						<tr>
							<td colspan="4">							
						...
						<tr align="center">
							<td align="left">
								<h5 style="color:#242424">Masukkan Kode Barang</h5>
							</td>
							<td style="width:23%" align="center">
								<input type="text" id="kode_barang_2" maxlength="20" name="kode_barang_2" class="form-control form-control-lg">
							</td>
							<td style="width:23%" align="left">
								<button onclick="cari_barang2()" value="simpan2" name="btn_cari_barang2" id="btn_cari_barang2" class="btn btn-primary btn-lg">Cari</button> 
							...
							<td style="width:30%" align="center">
								<form action="laporan-stok-ready-new.php" onsubmit="return cek_dulu3();" method="post" autocomplete="off" target="_blank">
									<button type="submit" class="btn btn-primary btn-lg btn-block" name="cetak_barang_ready">Cetak Barang Ready Saat ini</button>
								</form>
							</td>		
						</tr>
						...
						<table style="width:45%" border="0" align="left" cellpadding="0" cellspacing="0">
							...
							<tr align="left">
								<td colspan="5" align="left">
									<br>
									<br>
									<h5>Hasil Pencarian: <?php echo $tampil; ?></h5>
								</td>
							</tr>
							<tr align="left">
								<td colspan="5" align="left">
