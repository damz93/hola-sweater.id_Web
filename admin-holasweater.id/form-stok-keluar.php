		...
		<div class="bg">
			...
			<table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
				...
				<?php 
					...
					$data = mysqli_query($koneksi, "select COALESCE(sum(QTY),0) AS JUMLAHH,KODE_TRANSAKSI,KODE_TRANSAKSI_AUTO,PELANGGAN,TGL,WAKTU,OLEH from t_stok_keluar GROUP BY KODE_TRANSAKSI ORDER BY ID DESC");
