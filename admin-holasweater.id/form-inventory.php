...
<html>
   <head>
      ...
      <title>Data Inventory - S W E A T E R I N . M E</title>
   ...
   <div class="bg">
       <?php 
		...
		?>
      <h1 align='center' style="background-color:#71b8e4;color:#FFFFFe">DATA INVENTORY</h1>
      ...
      <a style="background-color:#71b8e4;color:#FFFFFe" href="input-inventory"> INPUT INVENTORY </a><br>
      <br>		
      <table id="tabel1" class="table table-striped" border="1" cellpadding="0" cellspacing="1">
         ...
         <?php 
            include 'koneksi.php';
            $no=1;
            $data = mysqli_query($koneksi,"select * from t_inventory order by ID DESC");
         ...
         <tr align="center">
            ...
            <td>			
               <a href='edit-inventory.php?kode_barang=<?php echo $kodbar; ?>' title="Edit Inventory">
               <img src="img/edit.png" class="img-responsive" height="100%"></a>	| 
               <a href='hapus-inventory?kode_barang=<?php echo $kodbar; ?>' title="Delete Inventory" onclick="return confirm('Are you sure you want to delete?')"><img src="img/delete.png" height="100%" ></a>
            </td>
         </tr>
         <?php 
            }
         ...
         $(document).ready(function() {
             ...
             $("#tabel1").DataTable({
                 ...
                 "language": {
                     ...
                     "infoPostFix": "",
                     "thousands": ".",
                     "lengthMenu": "Menampilkan _MENU_ Data Inventory",
