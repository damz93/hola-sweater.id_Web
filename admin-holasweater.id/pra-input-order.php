...
<html>
   <head>
     ...
     <script type="text/javascript" charset="utf8" src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
					...
					$.ajax({
						...
						success: function (data) {
							...
							if (kod1 == kod2){
								...
								document.getElementById("kode_order").value = ""; 
      ...
      <script type="text/javascript">
         function cek_resi(){			   
			 var kode_order = document.getElementById("kode_order").value; 
			 var n = kode_order.length;
			if (kode_order==""){
		...
		/*	else if (n != 12){
				...
				return confirm('Lanjut ke input order costum?');         	 
         	}			
         }
      </script>
   </head>
   ...
   <a style="background-color:#71b8e4;color:#FFFFFe" href="form-order.php"> Kembali ke Data Order </a><br>
      <div class="bg">
	   <form method="post" onsubmit="return cek_resi()" id="form_tampil" name="myff2" action="input-order">
               ...
               <div class="container">
                  ...
                  <table border="0" class="box" cellpadding="2" cellspacing="2" align=center>
                     <div class="form-group">
                        <tr>
                           <td align="center">
                              <input align="middle" autofocus placeholder="Scan Nomor Resi" onkeyup="cek_kodeorder();" type="text" name="kode_order" id="kode_order" class="form-control form-control-lg">
                           </td>
                           <td hidden align="center">
                              <input type="text" readonly="readonly" id="kode_order2" maxlength="8" name="kode_order2" class="form-control form-control-sm" value="0">
                           </td>
						</tr>		
						<tr hidden>
