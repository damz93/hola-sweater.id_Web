...
<html>
   <head>
      ...
      <title>Data Laporan - S W E A T E R I N . M E</title>
                  ...
                  <tr style="height:50%">
                     <td style="width:15%" valign="center" align="center">
                        ...
                        <div id="demo" class="collapse">
                           <form method="post" action="laporan-stok.php">
					...
					<td style="width:15%" valign="center" align="center">
                           <a href="laporan-inventory" title="Data Order">
                              <img src="img/report.png" class="img-responsive"style="display: block; margin: auto;">
                              <figcaption class="figure-caption" align='center'>
									<b>
                     ...
                     <td style="width:15%" valign="center" align="center">
                        ...
                        <figcaption class="figure-caption" align='center'>
                           ...
                           <form method="post" action="laporan-pemasukan.php">                              
                              ...
                              <br>
							   <h4><a data-toggle="collapse" data-target="#demo23" class="collapsible-btn btn-outline-info btn-lg">Pengeluaran Tahunan</a></h4>
                     ...
                     <td style="width:15%" valign="center" align="center">
                        ...
                        <form method="post" action="laporan-pengeluaran.php">
                           <div id="demo4" class="collapse">                             
                              ...
                              <div id="demo41" class="collapse">
                                 <input type="text" placeholder="Tanggal Awal"  id="example6dd" name="cek_tanggal2">
                                 <input type="text" placeholder="Tanggal Akhir"  id="example6" name="cek_tanggal2d">
                              ...
                              <div id="demo42" class="collapse">
                                 <input type="text" placeholder="Bulan Awal"  id="example5" name="cek_bulan2">
                                 <input type="text" placeholder="Bulan Akhir"  id="example5d" name="cek_bulan2d">
                              ...
                              <div id="demo43" class="collapse">
                                 <input type="text" placeholder="Tahun Awal" id="example4" name="cek_tahun2">
                                 <input type="text" placeholder="Tahun Akhir" id="example4d" name="cek_tahun2d">
                     ...
                     <td style="width:15%" valign="center" align="center">
                        ...
                        <form method="post" action="laporan-summary.php">
                           <div id="demo5" class="collapse">
                              ...
                              <div id="demo50" class="collapse">
                                 <input type="text" placeholder="Tanggal Awal"  id="example88" name="cek_tanggal3">
                                 <input type="text" placeholder="Tanggal Akhir"  id="example88d" name="cek_tanggal3d">
                              ...
                              <div id="demo51" class="collapse">
                                 <input type="text" placeholder="Bulan Awal"  id="example8" name="cek_bulan3">
                                 <input type="text" placeholder="Bulan Akhir"  id="example8d" name="cek_bulan3d">
                              ...
                              <div id="demo52" class="collapse">
                                 <input type="text" placeholder="Tahun Awal"  id="example7" name="cek_tahun3">
                                 <input type="text" placeholder="Tahun Akhir"  id="example7d" name="cek_tahun3d">
