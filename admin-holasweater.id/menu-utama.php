...
<html>
	...
	<body>
		<div class="sidebar">
			...
			<br>
			<a class="active" href="menu-utama"><b>Home</b></a>
			...
			<table style="width:93%" class="responsive" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td align="left" colspan="2">
						<img src="img/wcome.png" align="left"/></br>
						<p style="font-size:24pt;color:#284d58;text-align:left;font-weight:bold;">&nbsp<?php echo $username; ?></p>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<textarea style="width:100%;font-weight:bold;background-color:#284d58;color:#ffffff;font-size:18pt" class="form-control form-control-sm" rows="6" readonly="readonly" cols="4" name="t_area_deks" id="t_area_deks"><?php echo $kata; ?></textarea>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="right">
						<br>
						<p style="color:#284d58;font-size:14pt;font-weight:bold"><?php echo $tgl_lengk;?></p>
					<td>
				</tr>
				<tr>
					<td align="center" width="100%">
						<button id="btn_intip" type="button" class="collapsible">
							<p style="font-size:16pt;text-align:center;color:#284d58"><b>&darr; &nbsp Intip Pencapaian Hari ini Yuk &nbsp &darr;</b></p>
						</button>
						<div class="content2">
